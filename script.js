...
// Show the contact popup when the "Contact Us" button is clicked
...
// Show the Find Us popup when the "Find Us" button is clicked
document.getElementById("findUsButton").addEventListener("click", function() {
    document.getElementById("findUsPopup").style.display = "flex";
});

// Close the Find Us popup when the "Close" button is clicked
document.getElementById("closeFindUsPopupButton").addEventListener("click", function() {
    document.getElementById("findUsPopup").style.display = "none";
});
